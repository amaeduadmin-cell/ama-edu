...
export default async function render({ outlet }) {
  ...
  function applicationCard(application) {
    ...
    return h("section.card", {},
      ...
      h("div.form-grid.cols-2", {}, h("div", {}, h("div.u-small", { text: `Portal: ${application.requested_slug}.amaedu.com.ng` }), h("div.u-small", { text: `Type: ${application.school_type}` }), h("div.u-small", { text: `Sections: ${(application.sections || []).join(", ") || "Not specified"}` }), h("div.u-small", { text: `Students: ${application.declared_student_count ?? "Not supplied"}` }), h("div.u-small", { text: `Registration no.: ${application.registration_number || "Not supplied"}` })), h("div", {}, h("div.u-small", { text: `School email: ${application.school_email}` }), h("div.u-small", { text: `Administrator: ${application.admin_full_name}` }), h("div.u-small", { text: `Admin email: ${application.admin_email}` }), h("div.u-small", { text: application.address || "Address not supplied" }), h("div.u-small", { text: [application.ward, application.lga, application.state, application.country].filter(Boolean).join(", ") || "Location not supplied" }))),
