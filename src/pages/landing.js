...
function founderSection(content) {
  ...
  return h("section.section.section-light", {}, h("div.shell-width", {}, h("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: "clamp(28px, 6vw, 76px)", alignItems: "start" } },
    h("div", { style: { display: "grid", placeItems: "start" } }, image),
  ...
  return h("footer.site-foot", {},
    h("div.shell-width", {},
      h("div.site-foot-grid", {},
        ...
        h("nav", { "aria-label": "Footer" }, h("a", { href: "/register", text: "Register" }), h("a", { href: "/find-school", text: "Find my school" }), h("a", { href: "/login", text: "Platform sign in" }), h("a", { href: "/privacy", text: "Privacy" }), h("a", { href: "/terms", text: "Terms" }), h("a", { href: "/acceptable-use", text: "Acceptable use" })),
      ),
