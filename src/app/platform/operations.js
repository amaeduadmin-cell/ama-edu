...
export default async function render({ outlet }) {
  ...
  function draw(state) {
    ...
    mount(body,
      ...
      h("div.card", {}, h("h2.card-title", { text: "Billing plans" }), state.plans.length ? h("div.table-wrap", {}, h("table.table", {}, h("thead", {}, h("tr", {}, h("th", { text: "Plan" }), h("th", { text: "School type" }), h("th", { text: "Base" }), h("th", { text: "Per student" }), h("th", { text: "Period" }), h("th", { text: "Active" }))), h("tbody", {}, state.plans.map(plan => h("tr", {}, h("td", { text: plan.name }), h("td", { text: plan.school_type }), h("td", { text: `${plan.currency} ${plan.base_price}` }), h("td", { text: `${plan.currency} ${plan.price_per_student}` }), h("td", { text: plan.billing_period }), h("td", { text: plan.is_active ? "Yes" : "No" })))))) : h("p.u-muted", { text: "No billing plans configured yet. No prices are being invented or displayed." })),
